drop function if exists public.record_level_play(uuid);
...
create or replace function public.browse_completed_levels()
...
grant execute on function public.record_level_play(uuid, boolean) to anon, authenticated;
grant execute on function public.browse_gallery(text, text) to anon, authenticated;
grant execute on function public.browse_completed_levels() to authenticated;
